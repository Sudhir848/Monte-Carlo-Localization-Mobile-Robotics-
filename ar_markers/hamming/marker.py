...
class HammingMarker(object):
    ...
    def draw_local_frame(self, img, camK, linewidth=3):
        ...
        img_points = cv2.projectPoints(obj_points, self.rvec, self.tvec, camK, np.array([0,0,0,0], \
            dtype='float32'))[0]
        cv2.line(img, tuple((int(img_points[0][0][0]), int(img_points[0][0][1]))), tuple((int(img_points[1][0][0]), int(img_points[1][0][1]))), (0,0,255),thickness=linewidth)
        cv2.line(img, tuple((int(img_points[0][0][0]), int(img_points[0][0][1]))), tuple((int(img_points[2][0][0]), int(img_points[2][0][1]))), (0,255,0),thickness=linewidth)
        cv2.line(img, tuple((int(img_points[0][0][0]), int(img_points[0][0][1]))), tuple((int(img_points[3][0][0]), int(img_points[3][0][1]))), (255,0,0),thickness=linewidth)
